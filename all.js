let agotashi_list = [['江戸巾着', '江户巾袋', 550], ['青竹たこつみれ', '青竹章鱼团子', 460], ['牛タンわさび', '牛舌（有芥末）', 580], ['牛すじ', '牛筋', 320], ['豚のミルフィーユ', '猪肉千层酥', 280],  ['たけのこ', '筍', 250],  ['大根', '萝卜', 240], ['ちくわぶ', '竹轮麸', 220], ['厚揚げ', '油豆腐', 220], ['玉子', '蛋', 200], ['こんにゃく', '魔芋', 200], ['がんもどき', '什锦豆腐丸', 200], ['さつま揚げ', '甜不辣', 200],  ['白滝', '魔芋丝', 200], ['はんぺん', '板饼', 200], ['ちくわ', '竹轮', 200]]

let nashimeun = [['ホタテ貝', '扇贝', 280],['餅巾着', '麻糬福袋', 250],['高野豆腐', '高野豆腐', 200],['結び昆布', '昆布', 200],['とり天','鸡肉天妇罗',380]]
...
let otsumami_list = [['たこ刺し', '章鱼刺身', 580], ['肉味噌ピーマン', '肉味噌青椒', 0], ['なめろう', '味噌剁碎鱼刺身', 480], ['鴨燻製', '烟熏鸭', 480], ['ポテトサラダ', '薯仔沙拉', 480], ['梅水晶', '梅水晶', 480], ['板わさ', '	芥末魚板', 480], ['酒盜チーズ', '酒浸奶酪', 480], ['辛子明太子', '辣明太子', 380], ['烏賊塩辛', '墨鱼盐渍', 380], ['漬物盛り合わせ', '醃製物拼盘', 350], ['栃尾揚げ', '烤油豆腐', 420], ['だし巻き玉子', '日式蛋卷', 580],['枝豆','毛豆',380],['冷やしトマト','清涼番茄']]


let yakimono_list = [['鶏もも串', '鸡腿串', 220], ['ねぎま串', '葱鸡肉串', 220], ['ぼんじり串', '雞屁股', 220], ['砂肝串', '沙肝串', 220], ['つくね串', '鸡肉丸串', 380], ['ねぎ串', '葱串', 180]]

let agemono_list = [['ちくわ磯辺揚げ','炸竹轮',420],['たこ唐','炸章鱼',580],['結び昆布', '昆布', 200],['はもの天ぷら','海鰻天婦羅',770]]
