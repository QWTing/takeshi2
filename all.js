let agotashi_list = [['江戸巾着', '江户巾袋', 550], ['青竹たこつみれ', '青竹章鱼团子', 460], ['牛タンわさび', '牛舌（有芥末）', 580], ['牛すじ', '牛筋', 320], ['豚のミルフィーユ', '猪肉千层酥', 280],  ['たけのこ', '筍', 250],  ['大根', '萝卜', 240], ['ちくわぶ', '竹轮麸', 220], ['厚揚げ', '油豆腐', 220], ['玉子', '蛋', 200], ['こんにゃく', '魔芋', 200], ['がんもどき', '什锦豆腐丸', 200], ['さつま揚げ', '甜不辣', 200],  ['白滝', '魔芋丝', 200], ['はんぺん', '魚板', 200], ['ホタテ貝', '扇贝', 280],['餅巾着', '麻糬福袋', 250],['高野豆腐', '高野豆腐', 200],['結び昆布', '昆布', 200],['ちくわ', '竹轮', 200],['厚焼玉子', '日式蛋卷', 240]]


let toridashi_list = [['骨付き鶏', '雞腿（有附骨）', 980], ['トマト', '番茄', 380], ['牛タンつくれ', '牛舌团子', 300], ['ロールキャベツ', '高丽菜卷', 280], ['豚ネギ巻き', '猪肉葱卷', 280], ['焼売', '烧卖', 280], ['玉葱', '洋葱', 280], ['じゃがバター', '奶油土豆', 250], ['春菊', '茼蒿', 240], ['ヤングコーン', '嫩玉米', 200]]
